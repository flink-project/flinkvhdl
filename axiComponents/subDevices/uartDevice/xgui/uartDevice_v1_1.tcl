...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "number_of_uarts"
...
proc update_PARAM_VALUE.number_of_uarts { PARAM_VALUE.number_of_uarts } {
	# Procedure called to update number_of_uarts when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.number_of_uarts { PARAM_VALUE.number_of_uarts } {
	# Procedure called to validate number_of_uarts
	return true
}
...
proc update_MODELPARAM_VALUE.number_of_uarts { MODELPARAM_VALUE.number_of_uarts PARAM_VALUE.number_of_uarts } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.number_of_uarts}] ${MODELPARAM_VALUE.number_of_uarts}
}
