...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL loopback_device
set_fileset_property QUARTUS_SYNTH ENABLE_RELATIVE_INCLUDE_PATHS false
add_fileset_file loopback_device.m.vhd VHDL PATH loopback_device.m.vhd TOP_LEVEL_FILE
