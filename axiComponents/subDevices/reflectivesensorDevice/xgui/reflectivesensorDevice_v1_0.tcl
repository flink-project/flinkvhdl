...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "nof_decoder_signals"
  ipgui::add_param $IPINST -name "frequency_divider"
  ipgui::add_param $IPINST -name "ratio"
  ipgui::add_param $IPINST -name "adc_trigger"
...
proc update_MODELPARAM_VALUE.nof_decoder_signals { MODELPARAM_VALUE.nof_decoder_signals PARAM_VALUE.nof_decoder_signals } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.nof_decoder_signals}] ${MODELPARAM_VALUE.nof_decoder_signals}
}

proc update_MODELPARAM_VALUE.frequency_divider { MODELPARAM_VALUE.frequency_divider PARAM_VALUE.frequency_divider } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.frequency_divider}] ${MODELPARAM_VALUE.frequency_divider}
}
...
proc update_MODELPARAM_VALUE.adc_trigger { MODELPARAM_VALUE.adc_trigger PARAM_VALUE.adc_trigger } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.adc_trigger}] ${MODELPARAM_VALUE.adc_trigger}
}
