...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "nof_inputs"
  ipgui::add_param $IPINST -name "nof_outputs"
  ipgui::add_param $IPINST -name "value_interrupt_disabeld"
}
...
proc update_MODELPARAM_VALUE.nof_inputs { MODELPARAM_VALUE.nof_inputs PARAM_VALUE.nof_inputs } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.nof_inputs}] ${MODELPARAM_VALUE.nof_inputs}
}

proc update_MODELPARAM_VALUE.nof_outputs { MODELPARAM_VALUE.nof_outputs PARAM_VALUE.nof_outputs } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.nof_outputs}] ${MODELPARAM_VALUE.nof_outputs}
}

proc update_MODELPARAM_VALUE.value_interrupt_disabeld { MODELPARAM_VALUE.value_interrupt_disabeld PARAM_VALUE.value_interrupt_disabeld } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.value_interrupt_disabeld}] ${MODELPARAM_VALUE.value_interrupt_disabeld}
}
