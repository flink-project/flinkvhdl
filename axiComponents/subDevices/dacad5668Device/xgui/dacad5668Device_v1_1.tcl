...
proc init_gui { IPINST } {
  ...
  set_property tooltip {0.8 MHz < sclk_frequency < 16 MHz} ${sclk_frequency}
  set internal_reference [ipgui::add_param $IPINST -name "internal_reference"]
  set_property tooltip {true = internal reference, false = external reference} ${internal_reference}
...
proc update_PARAM_VALUE.internal_reference { PARAM_VALUE.internal_reference } {
	# Procedure called to update internal_reference when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.internal_reference { PARAM_VALUE.internal_reference } {
	# Procedure called to validate internal_reference
	return true
}
...
proc update_MODELPARAM_VALUE.internal_reference { MODELPARAM_VALUE.internal_reference PARAM_VALUE.internal_reference } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.internal_reference}] ${MODELPARAM_VALUE.internal_reference}
}
